export const STATE_DISTRICT_MAPPING: Record<string, string[]> = {
...
export const INDIAN_STATES = Object.keys(STATE_DISTRICT_MAPPING).sort();

export const INDIAN_SCHOOL_BOARDS = [
  'CBSE (Central Board of Secondary Education)',
  'ICSE (Council for the Indian School Certificate Examinations)',
  'State Board (State Education Department)',
...
export const GRADES_LIST = [
  ...
  '11th Grade (Science)',
  '11th Grade (Commerce)',
  '11th Grade (Arts/Humanities)',
  '12th Grade (Science)',
  '12th Grade (Commerce)',
  '12th Grade (Arts/Humanities)',
  'Undergraduate / College',
  'Postgraduate / Masters',
  'Competitive Exams (JEE / NEET / CUET / UPSC)'
];

export const COMMON_SCHOOL_TYPES = [
...
export const LEARNING_GOALS_LIST = [
  'Improve my grades',
  'Prepare for exams',
  'Understand difficult topics',
  'Complete homework',
  'Build strong concepts',
  'Learn beyond my syllabus',
  'Other'
];

export const LEARNING_STYLES_LIST = [
  'Simple explanations',
