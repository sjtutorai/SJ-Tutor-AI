...
import { 
  User, BookOpen, Bot, MessageSquare, Bell, Moon, 
  Smartphone, CreditCard, HelpCircle, ChevronRight, ChevronDown, ChevronUp,
  Save, LogOut, Trash2, Activity, Type, Palette, Monitor, Zap,
  Volume2, Terminal, Crown, Clock
} from 'lucide-react';
...
type SettingsTab = 'account' | 'learning' | 'aiTutor' | 'chat' | 'notifications' | 'appearance' | 'system' | 'billing' | 'help';
        ...
        return (
           <div className="space-y-6 animate-in fade-in slide-in-from-right-4 duration-300">
             ...
             <div className="flex bg-slate-100 dark:bg-slate-800 p-1 rounded-lg w-fit">
                <div className="px-4 py-1.5 text-sm font-medium rounded-md bg-white dark:bg-slate-700 text-primary-600 dark:text-primary-400 shadow-sm">
                  FAQ
                </div>
             </div>
