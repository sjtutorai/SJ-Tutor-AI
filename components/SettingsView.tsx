             ...
             <div className="bg-gradient-to-br from-slate-900 to-slate-800 text-white p-6 rounded-2xl shadow-lg relative overflow-hidden">
                ...
                <div className="relative z-10">
                   <div className="flex items-center gap-3 mb-2">
                      <div className="p-2 bg-white/10 rounded-lg backdrop-blur-sm"><Crown className="w-5 h-5 text-primary-400" /></div>
                      <span className="font-bold text-primary-400 tracking-wider text-sm uppercase">Current Plan</span>
                   </div>
                   ...
                   <div className="flex items-center justify-between bg-white/10 p-4 rounded-xl backdrop-blur-sm border border-white/5">
                      ...
                      <button 
                         ...
                         className="px-4 py-2 bg-primary-500 hover:bg-primary-600 text-white font-bold rounded-lg text-sm transition-colors"
                      >
                         Top Up
                      </button>
                   </div>
