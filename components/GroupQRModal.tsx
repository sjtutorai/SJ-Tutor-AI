...
export const GroupQRModal: React.FC<GroupQRModalProps> = ({
  ...
  // Primary share link
  const origin = typeof window !== 'undefined' ? window.location.origin : 'https://sj-tutorai.web.app';
  ...
  const handleDownloadQR = () => {
    try {
      ...
      img.onload = () => {
        ...
        ctx.fillText('Join at sj-tutorai.web.app', size / 2, 990);
          ...
          >
            ...
            <div className="p-2 rounded-2xl bg-white">
              <QRCodeSVG
                ...
                fgColor="#0f172a"
                imageSettings={{
                  src: "https://i.ibb.co/KpxwNSMS/SJ-Tutor-AI-Logo.jpg",
                  x: undefined,
                  y: undefined,
                  height: 38,
                  width: 38,
