        ...
        <div className="relative bg-white p-8 rounded-2xl shadow-2xl border border-slate-100 w-full max-w-md animate-in fade-in zoom-in duration-300">
          ...
          <div className="flex flex-col gap-3 mb-6">
            <button
              ...
              disabled={loading}
              className="w-full flex items-center justify-center gap-3 py-3 px-4 bg-white border border-slate-200 hover:border-slate-300 dark:border-slate-700 rounded-xl font-bold text-slate-700 dark:text-slate-200 hover:bg-slate-50 dark:hover:bg-slate-800 transition-all shadow-sm text-sm cursor-pointer"
            >
              {loading ? <Loader2 className="w-5 h-5 animate-spin" /> : (
                <>
                  <svg className="w-5 h-5 flex-shrink-0" viewBox="0 0 48 48">
                    <path fill="#EA4335" d="M24 9.5c3.54 0 6.71 1.22 9.21 3.6l6.85-6.85C35.9 2.38 30.47 0 24 0 14.62 0 6.51 5.38 2.56 13.22l7.98 6.19C12.43 13.72 17.74 9.5 24 9.5z"/>
                    <path fill="#4285F4" d="M46.5 24c0-1.63-.15-3.2-.43-4.75H24v9h12.75c-.55 2.85-2.17 5.27-4.59 6.89l7.13 5.53C43.43 36.52 46.5 30.76 46.5 24z"/>
                    <path fill="#FBBC05" d="M10.54 28.59c-.48-1.45-.76-2.99-.76-4.59s.27-3.14.76-4.59l-7.98-6.19C.92 16.46 0 20.12 0 24c0 3.88.92 7.54 2.56 10.78l7.98-6.19z"/>
                    <path fill="#34A853" d="M24 48c6.48 0 11.93-2.13 15.89-5.81l-7.13-5.53c-1.97 1.32-4.49 2.1-8.76 2.1-6.26 0-11.57-4.22-13.46-9.91l-7.98 6.19C6.51 42.62 14.62 48 24 48z"/>
                  </svg>
            ...
            <div className="grid grid-cols-2 gap-3">
               <button
                  ...
                  disabled={loading}
                  className="flex items-center justify-center gap-2 py-3 px-4 bg-black border border-black rounded-xl font-bold text-white hover:bg-gray-900 transition-all shadow-sm text-xs cursor-pointer"
              >
                  <AppleIcon className="w-4 h-4" />
                  <span>{view === 'login' ? 'Sign in with Apple' : 'Sign up with Apple'}</span>
              </button>
              <button
                  type="button"
                  onClick={() => handleProviderSignIn(githubProvider, 'GitHub')}
                  disabled={loading}
                  className="flex items-center justify-center gap-2 py-3 px-4 bg-slate-900 border border-slate-800 rounded-xl font-bold text-white hover:bg-slate-800 transition-all shadow-sm text-xs cursor-pointer"
              >
                  <Github className="w-4 h-4" />
                  <span>{view === 'login' ? 'Sign in with GitHub' : 'Sign up with GitHub'}</span>
              </button>
            </div>
          </div>
