...
const ResultsView: React.FC<ResultsViewProps> = ({ content, isLoading, title, type = 'Document', onBack, onGoToDashboard }) => {
        ...
        <div className="p-6 bg-slate-50 border-t border-slate-100">
            <div className="flex flex-col items-center gap-4">
                ...
                >
                    ...
                    {onGoToDashboard ? 'Go to Dashboard' : 'Generate Another Version'}
                </button>
            </div>
        </div>
      )}
