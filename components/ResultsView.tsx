...
import { Loader2, Volume2, Square, ArrowLeft, Download, FileText, Image as ImageIcon, FileType, Share2, Facebook, Instagram, Mail, Send, MessageCircle, Link } from 'lucide-react';
// @ts-ignore
  ...
  const handleShare = async (platform?: string) => {
    ...
    switch(platform) {
      case 'whatsapp':
        ...
        break;
      case 'facebook':
        shareUrl = `https://www.facebook.com/sharer/sharer.php?u=${encodeURIComponent(appUrl)}&quote=${encodeURIComponent(textToShare.substring(0, 100) + '...')}`;
        break;
      case 'telegram':
