        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              { icon: CameraIcon, title: "Homework Solver", desc: "Solve difficult homework problems instantly by scanning photos or typing your questions.", color: "bg-purple-50 text-purple-600" },
